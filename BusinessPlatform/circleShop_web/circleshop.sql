/*
 ...
 Source Schema         : circleshop

 Target Server Type    : MySQL
 Target Server Version : 80015
 File Encoding         : 65001

 Date: 25/10/2020 23:21:49
*/
...
CREATE TABLE `address`  (
  ...
  `province` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '省',
  `city` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '市',
  `district` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '区',
  `detail` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '详细信息',
...
CREATE TABLE `brands`  (
  ...
  `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '品牌名',
  `alias` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '别名',
  `logo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '标志图片',
...
-- Records of brands
-- ----------------------------
INSERT INTO `brands` VALUES (1, '苹果', 'Apple', NULL);
INSERT INTO `brands` VALUES (2, '三星', 'Samsung', NULL);
INSERT INTO `brands` VALUES (3, '华为', 'Huawei', NULL);
INSERT INTO `brands` VALUES (4, 'OPPO', 'oppo', NULL);
INSERT INTO `brands` VALUES (5, 'VIVO', 'vivo', NULL);
INSERT INTO `brands` VALUES (6, '小米', 'Mi', NULL);
INSERT INTO `brands` VALUES (7, '海尔', 'Haier', NULL);
INSERT INTO `brands` VALUES (8, '美的', 'Midea', NULL);
INSERT INTO `brands` VALUES (9, '格力', 'Gree', NULL);
INSERT INTO `brands` VALUES (10, '松下', 'Panasonic', NULL);
INSERT INTO `brands` VALUES (11, '索尼', 'Sony', NULL);
INSERT INTO `brands` VALUES (12, '戴尔', 'Dell', NULL);
INSERT INTO `brands` VALUES (13, '联想', 'Lenovo', NULL);
INSERT INTO `brands` VALUES (14, '惠普', 'HP', NULL);
INSERT INTO `brands` VALUES (15, '华硕', 'ASUS', NULL);
INSERT INTO `brands` VALUES (16, '微软', 'Micosoft', NULL);
...
CREATE TABLE `cart`  (
  `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '购物车列表id',
  `u_id` int(11) NOT NULL COMMENT '用户id',
  `gd_id` int(11) NOT NULL COMMENT '商品细节id',
...
CREATE TABLE `category`  (
  ...
  `cate_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '分类名',
  `lvl` int(11) NULL DEFAULT 0,
  `super` int(11) NULL DEFAULT 0,
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '移动设备', 1, 0);
INSERT INTO `category` VALUES (2, '办公设备', 1, 0);
INSERT INTO `category` VALUES (3, '家用电器', 1, 0);
INSERT INTO `category` VALUES (4, '智能穿戴', 1, 0);
INSERT INTO `category` VALUES (5, '游戏娱乐', 1, 0);
INSERT INTO `category` VALUES (6, '健康养生', 1, 0);
INSERT INTO `category` VALUES (7, '休闲影音', 1, 0);
INSERT INTO `category` VALUES (8, '户外设备', 1, 0);
INSERT INTO `category` VALUES (9, '电子电工', 1, 0);
INSERT INTO `category` VALUES (10, '安全设备', 1, 0);
INSERT INTO `category` VALUES (11, '研发设计', 1, 0);
INSERT INTO `category` VALUES (12, '学习辅助', 1, 0);
INSERT INTO `category` VALUES (13, '储存工具', 1, 0);
INSERT INTO `category` VALUES (14, '手机', 2, 1);
INSERT INTO `category` VALUES (15, '平板电脑', 2, 1);
INSERT INTO `category` VALUES (16, '音乐播放器', 2, 1);
INSERT INTO `category` VALUES (17, '电脑', 2, 2);
INSERT INTO `category` VALUES (18, '笔记本电脑', 2, 2);
INSERT INTO `category` VALUES (19, '打印机', 2, 2);
INSERT INTO `category` VALUES (20, '复印机', 2, 2);
INSERT INTO `category` VALUES (21, '电视', 2, 3);
INSERT INTO `category` VALUES (22, '冰箱', 2, 3);
INSERT INTO `category` VALUES (23, '洗衣机', 2, 3);
INSERT INTO `category` VALUES (24, '空调', 2, 3);
INSERT INTO `category` VALUES (25, '路由器', 2, 3);
INSERT INTO `category` VALUES (26, '手环', 2, 4);
INSERT INTO `category` VALUES (27, '计步器', 2, 4);
INSERT INTO `category` VALUES (28, 'VR眼镜', 2, 5);
INSERT INTO `category` VALUES (29, '鼠标', 2, 2);
INSERT INTO `category` VALUES (30, '键盘', 2, 2);
INSERT INTO `category` VALUES (31, '微波炉', 2, 3);
INSERT INTO `category` VALUES (32, '游戏机', 2, 5);
INSERT INTO `category` VALUES (33, '眼部', 2, 6);
INSERT INTO `category` VALUES (34, '足部', 2, 6);
INSERT INTO `category` VALUES (35, '背部', 2, 6);
INSERT INTO `category` VALUES (36, '全身', 2, 6);
INSERT INTO `category` VALUES (37, '耳机', 2, 7);
INSERT INTO `category` VALUES (38, '投影仪', 2, 7);
INSERT INTO `category` VALUES (39, '播放器', 2, 7);
INSERT INTO `category` VALUES (40, '传感器', 2, 9);
INSERT INTO `category` VALUES (41, '电子元件', 2, 9);
INSERT INTO `category` VALUES (42, '控制器', 2, 9);
INSERT INTO `category` VALUES (43, '监控摄像', 2, 10);
INSERT INTO `category` VALUES (44, '烟雾报警', 2, 10);
INSERT INTO `category` VALUES (45, '有害气体报警', 2, 10);
INSERT INTO `category` VALUES (46, '电路保护', 2, 10);
INSERT INTO `category` VALUES (47, '无人机', 2, 8);
INSERT INTO `category` VALUES (48, '数码相机', 2, 8);
INSERT INTO `category` VALUES (49, '红外传感', 2, 8);
INSERT INTO `category` VALUES (50, '声纳传感', 2, 8);
INSERT INTO `category` VALUES (51, 'U盘', 2, 13);
INSERT INTO `category` VALUES (52, '移动硬盘', 2, 13);
INSERT INTO `category` VALUES (53, '显卡', 2, 13);
INSERT INTO `category` VALUES (54, '内存', 2, 13);
INSERT INTO `category` VALUES (55, '固态硬盘', 2, 13);
INSERT INTO `category` VALUES (56, '扫地机器人', 2, 3);
...
CREATE TABLE `circle_user`  (
  ...
  `pwd` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '密码',
  `email` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'Email',
  `avatar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '头像',
  `birthday` date NULL DEFAULT NULL COMMENT '出生日期',
  `credit` int(11) NULL DEFAULT 200 COMMENT '信用',
  `points` int(11) NULL DEFAULT 0 COMMENT '积分',
  `state` int(11) NULL DEFAULT 1 COMMENT '状态，0禁用，1可用，2删除',
...
CREATE TABLE `goods`  (
  ...
  `g_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '商品名',
  `keywords` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '关键词',
  `brand` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '品牌',
  `state` int(11) NULL DEFAULT 0 COMMENT '状态，0未上架，1正在售卖',
  `create_time` date NULL DEFAULT NULL COMMENT '创建日期',
  `update_time` date NULL DEFAULT NULL COMMENT '更新日期',
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, 37, 'Beats Flex', '蓝牙/运动/待机长', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (2, 37, 'Beats Solo3', '蓝牙/头戴', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (3, 37, 'Beats Studio3', '蓝牙/头戴/音效好', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (4, 17, 'Mac Book Air 2018', '超薄/简约/生产工具/指纹识别', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (5, 17, 'Mac Book Pro 2019', '超薄/简约/生产工具/指纹识别', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (6, 17, 'Mate Book X 2020', '超薄/简约/生产工具/指纹识别', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (7, 17, 'Redmi Book', '超薄/简约/学习/休闲', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (8, 17, 'Redmi G', '游戏/电子竞技/性能/上网', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (9, 17, 'Redmi Pro', '大屏/简约/性能', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (10, 16, 'iPod Touch', '高音质/智能系统/便于携带/运动', '苹果', 1, '2020-10-01', '2020-10-01', './assets/goods/musicPlayer/iPod Touch/ipod-touch.png');
INSERT INTO `goods` VALUES (11, 15, 'iPad Air 2020', '简约/游戏/指纹识别', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (12, 15, 'iPad Mini 2019', '简约/便于携带/指纹识别', '苹果', 1, '2020-10-01', '2020-10-01', './assets/goods/pad/iPad Mini 2019/ipad-mini.jpg');
INSERT INTO `goods` VALUES (13, 15, 'iPad Pro 2020', '性能/生产工具/游戏/面部识别', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (14, 15, 'Mate Pad Pro', '性能/游戏', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (15, 14, 'Ace2', '拍照/双卡/游戏/VOOC闪充/面部识别/5G', 'OPPO', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (16, 14, 'Find X2', '拍照/双卡/游戏/性能/VOOC闪充/面部识别/5G', 'OPPO', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (17, 14, 'Galaxy Note20', '商务/双卡/性能/快充/指纹识别/5G', '三星', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (18, 14, 'Galaxy S20', '拍照/游戏/双卡/面部识别/快充/指纹是被/5G', '三星', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (19, 14, 'Galaxy A71', '拍照/游戏/指纹识别/快充', '三星', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (20, 14, 'Honor30', '性价比/双卡/拍照/指纹识别/快充/5G', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (21, 14, 'iPhone11', '性能/游戏/双卡/4G/面部识别', '苹果', 1, '2020-10-01', '2020-10-01', './assets/goods/phone/iPhone11/iphone11.jpg');
INSERT INTO `goods` VALUES (22, 14, 'iPhoneX', '性能/游戏/4G/面部识别', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (23, 14, 'Mate40 Pro', '性能/游戏/商务/双卡/拍照/5G/快充/指纹识别', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (24, 14, 'Mi10', '性能/游戏/双卡/5G/快充/面部识别', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (25, 14, 'Mi10 Pro', '性能/游戏/双卡/5G/快充/面部识别', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (26, 14, 'Nex 3S', '性能/游戏/双卡/5G/快充/音效好/面部识别', 'VIVO', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (27, 14, 'Nova7', '青春/游戏/双卡/5G/快充/指纹识别', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (28, 14, 'Redmi K30', '性价比/双卡/拍照/快充/面部识别', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (29, 14, 'Reno4', '性能/游戏/双卡/5G/VOOC闪充/面部识别', 'OPPO', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (30, 14, 'X50', '性能/游戏/双卡/5G/快充/面部识别', 'VIVO', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (31, 25, 'CPE T1', '大功率/穿墙/信号稳定/5G转wifi', 'OPPO', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (32, 25, '小米路由器 AX1800', '大功率/穿墙', '小米', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (33, 39, 'Home Pod', '高音质/蓝牙', '苹果', 1, '2020-10-01', '2020-10-01', './assets/goods/speaker/Home Pod/homepod.png');
INSERT INTO `goods` VALUES (34, 28, 'Huawei VR glass', '虚拟现实', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (35, 26, 'B6', '运动/睡眠监控/心率监控/来电提醒', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (36, 26, 'Huawei Watch GT 2e', '商务/来电提醒/睡眠监控/心率监控/血氧监控', '华为', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (37, 26, 'iWatch', '商务/运动/来电提醒', '苹果', 1, '2020-10-01', '2020-10-01', NULL);
INSERT INTO `goods` VALUES (38, 26, 'OPPO 手环', '运动/来电提醒/睡眠监控', 'OPPO', 1, '2020-10-01', '2020-10-01', NULL);
...
CREATE TABLE `goods_detail`  (
  `gd_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `price` double(64, 2) NULL DEFAULT 0.00 COMMENT '价格',
  ...
  `special` double(64, 2) NULL DEFAULT NULL COMMENT '促销价',
...
-- ----------------------------
INSERT INTO `goods_detail` VALUES (1, 1, 'Beats Flex – 适合全天佩戴的无线入耳式耳机 – 柚子黄', '柚子黄', 399.00, 100, './assets/goods/earphone/Beats Flex/beast-flex-yello.jpg', NULL);
INSERT INTO `goods_detail` VALUES (2, 1, 'Beats Flex – 适合全天佩戴的无线入耳式耳机 – 云雾灰', '云雾灰', 399.00, 100, './assets/goods/earphone/Beats Flex/beast-flex-white.jpg', NULL);
INSERT INTO `goods_detail` VALUES (3, 1, 'Beats Flex – 适合全天佩戴的无线入耳式耳机 – 经典黑红', '经典黑红', 399.00, 100, './assets/goods/earphone/Beats Flex/beast-flex-black.jpg', NULL);
INSERT INTO `goods_detail` VALUES (4, 1, 'Beats Flex – 适合全天佩戴的无线入耳式耳机 – 冷焰蓝', '冷艳蓝', 399.00, 100, './assets/goods/earphone/Beats Flex/beast-flex-blue.jpg', NULL);
INSERT INTO `goods_detail` VALUES (5, 2, 'Beats Solo3 Wireless 头戴式耳机 - 玫瑰金色', '玫瑰金色', 1699.00, 120, './assets/goods/earphone/Beats Solo3/beats-solo-gold.jpg', NULL);
INSERT INTO `goods_detail` VALUES (6, 2, 'Beats Solo3 Wireless 头戴式耳机 - 哑光黑色', '哑光黑色', 1699.00, 120, './assets/goods/earphone/Beats Solo3/beats-solo-black.jpg', NULL);
INSERT INTO `goods_detail` VALUES (7, 2, 'Beats Solo3 Wireless 头戴式耳机 - 橙红色', '橙红色', 1699.00, 120, './assets/goods/earphone/Beats Solo3/beats-solo-red.jpg', NULL);
INSERT INTO `goods_detail` VALUES (8, 3, 'Beats Studio3 Wireless 头戴式耳机 - 魅影灰', '魅影灰', 2789.00, 150, './assets/goods/earphone/Beats Studio3/beats-studio-black-grey.jpg', NULL);
INSERT INTO `goods_detail` VALUES (9, 3, 'Beats Studio3 Wireless 头戴式耳机 - 红色', '红色', 2789.00, 150, './assets/goods/earphone/Beats Studio3/beats-studio-red.jpg', NULL);
INSERT INTO `goods_detail` VALUES (10, 3, 'Beats Studio3 Wireless 头戴式耳机 - 白色', '白色', 2789.00, 150, './assets/goods/earphone/Beats Studio3/beats-studio-while.jpg', NULL);
INSERT INTO `goods_detail` VALUES (11, 3, 'Beats Studio3 Wireless 头戴式耳机 - 哑光黑色', '哑光黑色', 2789.00, 150, './assets/goods/earphone/Beats Studio3/beats-studio-black.jpg', NULL);
INSERT INTO `goods_detail` VALUES (12, 4, '13 英寸 MacBook Air [1.1GHz 4 核 Core i5 处理器，Turbo Boost 最高可达 3.5GHz\r\n512GB 存储容量\r\n触控 ID]', '深空灰色', 9999.00, 80, './assets/goods/laptop/Mac Book Air 2018/macbook-air-spacegray.jpg', NULL);
INSERT INTO `goods_detail` VALUES (13, 4, '13 英寸 MacBook Air [1.1GHz 4 核 Core i5 处理器，Turbo Boost 最高可达 3.5GHz\r\n512GB 存储容量\r\n触控 ID]', '金色', 9999.00, 100, './assets/goods/laptop/Mac Book Air 2018/macbook-air-gold.jpg', NULL);
INSERT INTO `goods_detail` VALUES (14, 4, '13 英寸 MacBook Air [1.1GHz 4 核 Core i5 处理器，Turbo Boost 最高可达 3.5GHz\r\n512GB 存储容量\r\n触控 ID]', '银色', 9999.00, 100, './assets/goods/laptop/Mac Book Air 2018/macbook-air-silver.jpg', NULL);
INSERT INTO `goods_detail` VALUES (15, 5, '16 英寸 MacBook Pro [2.3GHz 8 核处理器\r\n1TB 存储容量\r\nAMD Radeon Pro 5500M]', '深空灰色', 22199.00, 50, './assets/goods/laptop/Mac Book Pro 2019/mbp-space.jpg', 18999.00);
INSERT INTO `goods_detail` VALUES (16, 5, '16 英寸 MacBook Pro [2.3GHz 8 核处理器\r\n1TB 存储容量\r\nAMD Radeon Pro 5500M]', '银色', 22199.00, 50, './assets/goods/laptop/Mac Book Pro 2019/mbp-silver.jpg', 18999.00);
INSERT INTO `goods_detail` VALUES (17, 6, 'HUAWEI MateBook X 2020款 集显 i5 16G 512G（冰霜银）13英寸3K触控全面屏 轻至1kg超轻薄华为笔记本电脑', '冰霜银', 8999.00, 200, './assets/goods/laptop/Mate Book X 2020/matebook-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (18, 6, 'HUAWEI MateBook X 2020款 集显 i5 16G 512G（青山黛）13英寸3K触控全面屏 轻至1kg超轻薄华为笔记本电脑', '青山黛', 8999.00, 200, './assets/goods/laptop/Mate Book X 2020/matebook-green.png', NULL);
INSERT INTO `goods_detail` VALUES (19, 7, 'RedmiBook 16 全新十代酷睿处理器 / MX350独显 / 16英寸超窄边框高清屏', '灰色', 4499.00, 105, './assets/goods/laptop/Redmi Book/redmi-book-grey.jpg', NULL);
INSERT INTO `goods_detail` VALUES (20, 8, 'Redmi G 游戏本 i5-10200H/16G/512G/60Hz', '黑色', 5499.00, 300, './assets/goods/laptop/Redmi G/redmi-g-black.jpg', 5199.00);
INSERT INTO `goods_detail` VALUES (21, 8, 'Redmi G 游戏本 i7-10750H/16G/512G/144Hz', '黑色', 6599.00, 200, './assets/goods/laptop/Redmi G/redmi-g-black.jpg', 6299.00);
INSERT INTO `goods_detail` VALUES (22, 9, 'Pro 15.6\" 2020款 I5-10210U 4C/8G/512G/MX350 2GB', '灰色', 5799.00, 0, './assets/goods/laptop/Redmi Pro/redmi-pro-grey.jpg', NULL);
INSERT INTO `goods_detail` VALUES (23, 10, 'iPod touch – 粉红色', '粉红色', 1599.00, 60, './assets/goods/musicPlayer/iPod Touch/ipod-touch-pink.png', NULL);
INSERT INTO `goods_detail` VALUES (24, 10, 'iPod touch – 深空灰色', '深空灰色', 1599.00, 100, './assets/goods/musicPlayer/iPod Touch/ipod-toucht-spacegray.png', NULL);
INSERT INTO `goods_detail` VALUES (25, 10, 'iPod touch – 银色', '银色', 1599.00, 100, './assets/goods/musicPlayer/iPod Touch/ipod-touch-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (26, 10, 'iPod touch – 蓝色', '蓝色', 1599.00, 100, './assets/goods/musicPlayer/iPod Touch/ipod-touch-blue.png', NULL);
INSERT INTO `goods_detail` VALUES (27, 11, 'iPad Air 2020 – 无线局域网 64GB – 玫瑰金', '玫瑰金', 4799.00, 500, './assets/goods/musicPlayer/pad/iPad Air 2020/ipad-2020-gold.png', NULL);
INSERT INTO `goods_detail` VALUES (28, 11, 'iPad Air 2020 – 无线局域网 64GB – 深空灰色', '深空灰色', 4799.00, 500, './assets/goods/musicPlayer/pad/iPad Air 2020/ipad-2020-space.png', NULL);
INSERT INTO `goods_detail` VALUES (29, 11, 'iPad Air 2020 – 无线局域网 64GB – 银色', '银色', 4799.00, 500, './assets/goods/musicPlayer/pad/iPad Air 2020/ipad-2020-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (30, 12, 'iPad mini 2019 – 无限局域网 64GB – 金色', '金色', 2921.00, 300, './assets/goods/musicPlayer/pad/iPad Mini 2019/ipad-mini-gold.png', NULL);
INSERT INTO `goods_detail` VALUES (31, 12, 'iPad mini 2019 – 无限局域网 64GB – 深空灰色', '深空灰色', 2921.00, 300, './assets/goods/musicPlayer/pad/iPad Mini 2019/ipad-mini-spacegray.png', NULL);
INSERT INTO `goods_detail` VALUES (32, 12, 'iPad mini 2019 – 无限局域网 64GB – 银色', '银色', 2921.00, 300, './assets/goods/musicPlayer/pad/iPad Mini 2019/ipad-mini-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (33, 13, 'iPad Pro 2020 – 无线局域网 128GB 11英寸 – 深空灰色', '深空灰色', 6299.00, 200, './assets/goods/musicPlayer/pad/iPad Pro 2020/ipad-pro-spacegray.png', NULL);
INSERT INTO `goods_detail` VALUES (34, 13, 'iPad Pro 2020 – 无线局域网 128GB 11英寸 – 银色', '银色', 6299.00, 200, './assets/goods/musicPlayer/pad/iPad Pro 2020/ipad-pro-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (35, 14, 'HUAWEI MatePad Pro 10.8英寸华为智能平板电脑 8GB+256GB 全网通（夜阑灰）绚丽全面屏学生平板 麒麟990芯片 手机平板多屏协同 轻办公平板电脑', '夜阑灰', 4499.00, 350, './assets/goods/musicPlayer/pad/Mate Pad Pro/mtp-black.png', 4155.00);
INSERT INTO `goods_detail` VALUES (36, 14, 'HUAWEI MatePad Pro 10.8英寸华为智能平板电脑 8GB+256GB WiFi（青山黛）+智能磁吸键盘+手写笔 绚丽全面屏学生平板 麒麟990芯片 手机平板多屏协同 轻办公平板电脑', '青山黛', 4499.00, 350, './assets/goods/musicPlayer/pad/Mate Pad Pro/mtp-green.png', 4155.00);
INSERT INTO `goods_detail` VALUES (37, 14, 'HUAWEI MatePad Pro 10.8英寸华为智能平板电脑 8GB+256GB WiFi（贝母白）绚丽全面屏学生平板 麒麟990芯片 手机平板多屏协同 轻办公平板电脑', '贝母白', 4499.00, 350, './assets/goods/musicPlayer/pad/Mate Pad Pro/mtp-white.png', 4155.00);
INSERT INTO `goods_detail` VALUES (38, 15, 'OPPO Ace2 8G+128G 月岩灰', '月岩灰', 3999.00, 600, './assets/goods/phone/Ace2/ace-black.png', 3299.00);
INSERT INTO `goods_detail` VALUES (39, 15, 'OPPO Ace2 8G+128G 极光银', '极光银', 3999.00, 600, './assets/goods/phone/Ace2/ace-silver.png', 3299.00);
INSERT INTO `goods_detail` VALUES (40, 15, 'OPPO Ace2 8G+128G 梦幻紫', '梦幻紫', 3999.00, 600, './assets/goods/phone/Ace2/ace-purple.png', 3299.00);
INSERT INTO `goods_detail` VALUES (41, 16, 'Find X2 8G+256G 夜海', '夜海', 4999.00, 500, './assets/goods/phone/Find X2/findx2-black.png', NULL);
INSERT INTO `goods_detail` VALUES (42, 16, 'Find X2 8G+256G 碧波', '碧波', 4999.00, 500, './assets/goods/phone/Find X2/findx2-blue.png', NULL);
INSERT INTO `goods_detail` VALUES (43, 16, '\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nFind X2 8G+256G 茶橘', '茶橘', 4999.00, 500, './assets/goods/phone/Find X2/findx2-orange.png', NULL);
INSERT INTO `goods_detail` VALUES (44, 16, 'Find X2 8G+256G 英雄联盟S10限定版', '英雄联盟S10限定版', 4999.00, 500, './assets/goods/phone/Find X2/findx2-lol.png', NULL);
INSERT INTO `goods_detail` VALUES (45, 17, 'Galaxy Note20 Ultra 5G [12GB RAM, 256GB ROM] - 迷雾金', '迷雾金', 9199.00, 200, './assets/goods/phone/Galaxy Note20/galaxy-note-gold.jpg', 8699.00);
INSERT INTO `goods_detail` VALUES (46, 17, 'Galaxy Note20 Ultra 5G [12GB RAM, 256GB ROM] - 初露白', '初露白', 9199.00, 0, './assets/goods/phone/Galaxy Note20/galaxy-note-silver.jpg', 8699.00);
INSERT INTO `goods_detail` VALUES (47, 17, 'Galaxy Note20 Ultra 5G [12GB RAM, 256GB ROM] - 曜岩黑', '曜岩黑', 9199.00, 200, './assets/goods/phone/Galaxy Note20/galaxy-note-black.jpg', 8699.00);
INSERT INTO `goods_detail` VALUES (48, 18, 'Samsung Galaxy S20 5G - 意象白', '意象白', 6999.00, 300, './assets/goods/phone/Galaxy S20/galaxy-sliver.jpg', 5999.00);
INSERT INTO `goods_detail` VALUES (49, 18, 'Samsung Galaxy S20 5G - 遐想灰', '遐想灰', 6999.00, 300, './assets/goods/phone/Galaxy S20/galaxy-grey.jpg', 5999.00);
INSERT INTO `goods_detail` VALUES (50, 18, 'Samsung Galaxy S20 5G - 浮氧蓝', '浮氧蓝', 6999.00, 300, './assets/goods/phone/Galaxy S20/galaxy-blue.jpg', 5999.00);
INSERT INTO `goods_detail` VALUES (51, 18, 'Samsung Galaxy S20 5G - 柔雾粉', '柔雾粉', 6999.00, 300, './assets/goods/phone/Galaxy S20/galaxy-pink.jpg', 5999.00);
INSERT INTO `goods_detail` VALUES (52, 19, 'Galaxy A71 双模5G芯片 - 切割蓝', '切割蓝', 3399.00, 200, './assets/goods/phone/Galaxy A71/galaxy-a-blue.jpg', 3199.00);
INSERT INTO `goods_detail` VALUES (53, 19, 'Galaxy A71 双模5G芯片 - 镭丝黑', '镭丝黑', 3399.00, 200, './assets/goods/phone/Galaxy A71/galaxy-a-black.jpg', 3199.00);
INSERT INTO `goods_detail` VALUES (54, 19, 'Galaxy A71 双模5G芯片 - 雕刻银', '雕刻银', 3399.00, 200, './assets/goods/phone/Galaxy A71/galaxy-a-silver.jpg', 3199.00);
INSERT INTO `goods_detail` VALUES (55, 20, '荣耀30 50倍超稳远摄 超感光高清夜拍 40W超级快充 双模5G 8GB+128GB 幻夜黑', '幻夜黑', 3199.00, 460, './assets/goods/phone/Honor30/honor-black.png', 2999.00);
INSERT INTO `goods_detail` VALUES (56, 20, '荣耀30 50倍超稳远摄 超感光高清夜拍 40W超级快充 双模5G 8GB+128GB 绿野仙踪', '绿野仙踪', 3199.00, 500, './assets/goods/phone/Honor30/honor-green.png', 2999.00);
INSERT INTO `goods_detail` VALUES (57, 20, '荣耀30 50倍超稳远摄 超感光高清夜拍 40W超级快充 双模5G 8GB+128GB 钛空银', '钛空银', 3199.00, 460, './assets/goods/phone/Honor30/honor-silver.png', 2999.00);
INSERT INTO `goods_detail` VALUES (58, 20, '荣耀30 50倍超稳远摄 超感光高清夜拍 40W超级快充 双模5G 8GB+128GB 霓影紫', '霓影紫', 3199.00, 460, './assets/goods/phone/Honor30/honor-purple.png', 2999.00);
INSERT INTO `goods_detail` VALUES (59, 21, 'iPhone 11 –  白色', '白色', 4799.00, 100, './assets/goods/phone/iPhone11/iphone11-white.png', NULL);
INSERT INTO `goods_detail` VALUES (60, 21, 'iPhone 11 –  黑色', '黑色', 4799.00, 100, './assets/goods/phone/iPhone11/iphone11-black.png', NULL);
INSERT INTO `goods_detail` VALUES (61, 21, 'iPhone 11 –  绿色', '绿色', 4799.00, 100, './assets/goods/phone/iPhone11/iphone11-green.png', NULL);
INSERT INTO `goods_detail` VALUES (62, 21, 'iPhone 11 –  黄色', '黄色', 4799.00, 100, './assets/goods/phone/iPhone11/iphone11-yellow.png', NULL);
INSERT INTO `goods_detail` VALUES (63, 21, 'iPhone 11 –  紫色', '紫色', 4799.00, 100, './assets/goods/phone/iPhone11/iphone11-purple.png', NULL);
INSERT INTO `goods_detail` VALUES (64, 21, 'iPhone 11 –  红色', '红色', 4799.00, 100, './assets/goods/phone/iPhone11/iphone11-red.png', NULL);
INSERT INTO `goods_detail` VALUES (65, 22, 'iPhone X – 黑色', '黑色', 3999.00, 60, './assets/goods/phone/iPhoneX/iphone-x-black.png', NULL);
INSERT INTO `goods_detail` VALUES (66, 22, 'iPhone X – 蓝色', '蓝色', 3999.00, 60, './assets/goods/phone/iPhoneX/iphone-x-blue.png', NULL);
INSERT INTO `goods_detail` VALUES (67, 22, 'iPhone X – 红色', '红色', 3999.00, 60, './assets/goods/phone/iPhoneX/iphone-x-red.png', NULL);
INSERT INTO `goods_detail` VALUES (68, 22, 'iPhone X – 白色', '白色', 3999.00, 60, './assets/goods/phone/iPhoneX/iphone-x-white.png', NULL);
INSERT INTO `goods_detail` VALUES (69, 23, 'HUAWEI Mate 40 Pro 5G 全网通 8GB+256GB（亮黑色）', '亮黑色', 8299.00, 400, './assets/goods/phone/Mate40 Pro/mate-black.png', 8099.00);
INSERT INTO `goods_detail` VALUES (70, 23, 'HUAWEI Mate 40 Pro 5G 全网通 8GB+256GB（釉白色）', '釉白色', 8299.00, 500, './assets/goods/phone/Mate40 Pro/mate-white.png', 8099.00);
INSERT INTO `goods_detail` VALUES (71, 23, 'HUAWEI Mate 40 Pro 5G 全网通 8GB+256GB（绿色）', '绿色', 8299.00, 500, './assets/goods/phone/Mate40 Pro/mate-deepgreen.png', 8099.00);
INSERT INTO `goods_detail` VALUES (72, 23, 'HUAWEI Mate 40 Pro 5G 全网通 8GB+256GB（黄色）', '黄色', 8299.00, 400, './assets/goods/phone/Mate40 Pro/mate-yello.png', 8099.00);
INSERT INTO `goods_detail` VALUES (73, 24, '小米10至尊纪念版 - 陶瓷黑', '陶瓷黑', 5599.00, 350, './assets/goods/phone/Mi10/mi-black.jpg', NULL);
INSERT INTO `goods_detail` VALUES (74, 24, '小米10至尊纪念版 - 透明版', '透明版', 5599.00, 350, './assets/goods/phone/Mi10/mi-opacity.jpg', NULL);
INSERT INTO `goods_detail` VALUES (75, 24, '小米10至尊纪念版 - 亮银版', '亮银版', 5599.00, 350, './assets/goods/phone/Mi10/mi-sliver.jpg', NULL);
INSERT INTO `goods_detail` VALUES (76, 25, '小米10 Pro - 向往的生活同款 / 骁龙865处理器 / 5G双模 / 8GB+256GB - 星空蓝', '星空蓝', 4999.00, 200, './assets/goods/phone/Mi10 Pro/mi-pro-blue.jpg', NULL);
INSERT INTO `goods_detail` VALUES (77, 25, '小米10 Pro - 向往的生活同款 / 骁龙865处理器 / 5G双模 / 8GB+256GB - 珍珠白', '珍珠白', 4999.00, 200, './assets/goods/phone/Mi10 Pro/mi-pro-white.jpg', NULL);
INSERT INTO `goods_detail` VALUES (78, 26, 'NEX 3S 5G版 8GB+256GB 深空流光', '深空流光', 5298.00, 700, './assets/goods/phone/Nex 3S/nex-black.png', NULL);
INSERT INTO `goods_detail` VALUES (79, 26, 'NEX 3S 5G版 12GB+256GB 液态天河', '液态天河', 5298.00, 750, './assets/goods/phone/Nex 3S/nex-blue.png', NULL);
INSERT INTO `goods_detail` VALUES (80, 26, 'NEX 3S 5G版 12GB+256GB 琥珀醇', '琥珀醇', 5298.00, 700, './assets/goods/phone/Nex 3S/nex-orange.png', NULL);
INSERT INTO `goods_detail` VALUES (81, 27, 'HUAWEI nova 7 SE 5G 活力版 8GB+128GB 全网通版（银月星辉）', '银月星辉', 2299.00, 510, './assets/goods/phone/Nova7/nova-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (82, 27, 'HUAWEI nova 7 SE 5G 活力版 8GB+128GB 全网通版（绮境森林）', '绮境森林', 2299.00, 510, './assets/goods/phone/Nova7/nova-green.png', NULL);
INSERT INTO `goods_detail` VALUES (83, 27, 'HUAWEI nova 7 SE 5G 活力版 8GB+128GB 全网通版（幻夜黑）', '幻夜黑', 2299.00, 510, './assets/goods/phone/Nova7/nova-black.png', NULL);
INSERT INTO `goods_detail` VALUES (84, 27, 'HUAWEI nova 7 SE 5G 活力版 8GB+128GB 全网通版（仲夏紫）', '仲夏紫', 2299.00, 510, './assets/goods/phone/Nova7/nova-purple.png', NULL);
INSERT INTO `goods_detail` VALUES (85, 28, 'Redmi K30 5G [8GB+128GB/256GB] 深海微光', '深海微光', 1599.00, 300, './assets/goods/phone/Redmi K30/redmi-blue.jpg', NULL);
INSERT INTO `goods_detail` VALUES (86, 28, 'Redmi K30 5G [8GB+128GB/256GB] 紫玉幻境', '紫玉幻境', 1599.00, 300, './assets/goods/phone/Redmi K30/redmi-purple.jpg', NULL);
INSERT INTO `goods_detail` VALUES (87, 29, 'Reno4 5G 晶钻红 8G+128G', '晶钻红', 3799.00, 480, './assets/goods/phone/Reno4/reno-red.png', NULL);
INSERT INTO `goods_detail` VALUES (88, 29, 'Reno4 5G 晶钻蓝 8G+128G', '晶钻蓝', 3799.00, 500, './assets/goods/phone/Reno4/reno-blue.png', NULL);
INSERT INTO `goods_detail` VALUES (89, 29, 'Reno4 5G 梦镜黑 8G+128G', '梦镜黑', 3799.00, 480, './assets/goods/phone/Reno4/reno-black.png', NULL);
INSERT INTO `goods_detail` VALUES (90, 30, 'vivo X50 5G版 8GB+256GB 引力', '引力', 5498.00, 350, './assets/goods/phone/X50/x-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (91, 30, 'vivo X50 5G版 8GB+256GB 驼色', '驼色', 5498.00, 350, './assets/goods/phone/X50/x-orange.png', NULL);
INSERT INTO `goods_detail` VALUES (92, 31, 'OPPO 5G CPE T1 移动路由器 皓白', '皓白', 1999.00, 120, './assets/goods/router/CPE T1/cpe-white.png', NULL);
INSERT INTO `goods_detail` VALUES (93, 32, '小米路由器 AX1800', '黑色', 329.00, 200, './assets/goods/router/小米路由器 AX1800/mi-router-black.jpg', NULL);
INSERT INTO `goods_detail` VALUES (94, 33, 'HomePod  –  深空灰色', '深空灰色', 2299.00, 210, './assets/goods/speaker/Home Pod/homepod-spacegray.jpg', NULL);
INSERT INTO `goods_detail` VALUES (95, 33, 'HomePod  –  白色', '白色', 2299.00, 200, './assets/goods/speaker/Home Pod/homepod-white.jpg', NULL);
INSERT INTO `goods_detail` VALUES (96, 34, 'HUAWEI VR Glass（亮黑色）', '亮黑色', 2999.00, 150, './assets/goods/VR glass/Huawei VR glass/vr-black.png', NULL);
INSERT INTO `goods_detail` VALUES (97, 35, '华为手环 B6 运动版（曜石黑）智能通话手环3D弧面触控彩屏心率血氧监测睡眠分析', '曜石黑', 999.00, 200, './assets/goods/wristband/B6/b6-black.png', NULL);
INSERT INTO `goods_detail` VALUES (98, 35, '华为手环 B6 运动版（珊瑚红）智能通话手环3D弧面触控彩屏心率血氧监测睡眠分析', '珊瑚红', 999.00, 210, './assets/goods/wristband/B6/b6-red.png', NULL);
INSERT INTO `goods_detail` VALUES (99, 35, '华为手环 B6 时尚版（钛银灰）智能通话手环3D弧面触控彩屏心率血氧监测睡眠分析', '钛银灰', 999.00, 210, './assets/goods/wristband/B6/b6-silver.png', NULL);
INSERT INTO `goods_detail` VALUES (100, 36, 'HUAWEI WATCH GT 2e 运动款（曜石黑）两周续航 百种运动类型 音乐播放 多彩表盘 华为智能手表', '曜石黑', 1288.00, 300, './assets/goods/wristband/Huawei Watch  GT 2e/huawei-watch-black.png', NULL);
INSERT INTO `goods_detail` VALUES (101, 36, 'HUAWEI WATCH GT 2e 运动款（熔岩红）两周续航 百种运动类型 音乐播放 多彩表盘 华为智能手表', '熔岩红', 1288.00, 300, './assets/goods/wristband/Huawei Watch  GT 2e/huawei-watch-red.png', NULL);
INSERT INTO `goods_detail` VALUES (102, 36, 'HUAWEI WATCH GT 2e 活力款（冰川白）两周续航 百种运动类型 音乐播放 多彩表盘 华为智能手表', '冰川白', 1288.00, 300, './assets/goods/wristband/Huawei Watch  GT 2e/huawei-watch-green.png', NULL);
INSERT INTO `goods_detail` VALUES (103, 37, 'Apple Watch 单圈表带', '单圈表带', 2199.00, 50, './assets/goods/wristband/iWatch/watch-se-whole.jpg', NULL);
INSERT INTO `goods_detail` VALUES (104, 37, 'Apple Watch 回环式运动型表带', '回环式运动型表带', 2199.00, 50, './assets/goods/wristband/iWatch/watch-se-classic.jpg', NULL);
INSERT INTO `goods_detail` VALUES (105, 37, 'Apple Watch 运动型表带', '运动型表带', 2199.00, 50, './assets/goods/wristband/iWatch/watch-se-sport.jpg', NULL);
INSERT INTO `goods_detail` VALUES (106, 38, 'OPPO手环（静夜黑）连续血氧监测，12种运动模式，超长续航', '静夜黑', 199.00, 60, './assets/goods/wristband/OPPO 手环/oppo-souhuan-black.png', NULL);
INSERT INTO `goods_detail` VALUES (107, 38, 'OPPO手环（薄雾紫）连续血氧监测，12种运动模式，超长续航', '薄雾紫', 199.00, 60, './assets/goods/wristband/OPPO 手环/oppo-souhuan-pink.png', NULL);
...
CREATE TABLE `goods_order`  (
  ...
  `o_num` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '订单编号',
  `o_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '订单名称',
  `u_id` int(11) NOT NULL COMMENT '用户id',
  `gd_id` int(11) NOT NULL COMMENT '商品细节id',
  `price` double NULL DEFAULT 0 COMMENT '单价',
  `amount` int(11) NULL DEFAULT 1 COMMENT '数量',
  `totel_price` double NULL DEFAULT 0 COMMENT '总价',
  `state` int(11) NULL DEFAULT 0 COMMENT '状态，0未完成，1完成支付，2完成订单，3取消',
  `details` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '细节信息',
...
-- ----------------------------
-- Table structure for goods_order_comments
-- ----------------------------
DROP TABLE IF EXISTS `goods_order_comments`;
CREATE TABLE `goods_order_comments`  (
  `oc_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `u_id` int(11) NOT NULL COMMENT '用户id',
  `g_id` int(11) NOT NULL COMMENT '商品id',
...
-- ----------------------------
-- Records of goods_order_comments
-- ----------------------------
...
CREATE TABLE `goods_record`  (
  `gr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `g_id` int(11) NOT NULL COMMENT '商品id',
  `views` int(11) NULL DEFAULT 0 COMMENT '浏览记录',
  `deals` int(11) NULL DEFAULT 0 COMMENT '成交记录',
  `record_date` date NULL DEFAULT NULL COMMENT '记录日',
...
CREATE TABLE `user_behavior`  (
  `ub_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `u_id` int(11) NOT NULL COMMENT '用户id',
  `u_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户名',
  `behave` int(11) NOT NULL COMMENT '行为，0登录，1修改，2搜索，3浏览',
  `target` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '行为目标',
  `detail` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '详细描述',
  `create_time` date NULL DEFAULT NULL COMMENT '创建日期',
...
CREATE TABLE `user_record`  (
  `ur_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `visits` int(11) NULL DEFAULT 0 COMMENT '访问量',
  `regists` int(11) NULL DEFAULT 0 COMMENT '注册量',
  `record_date` date NULL DEFAULT NULL COMMENT '记录日',
